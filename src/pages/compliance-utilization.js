/** src/pages/compliance-utilization.js — Vue 3 Component */
window.DynCompliance = {
  name: 'DynCompliance',
  ...
  setup(props) {
    ...
    onMounted(async () => {
      ...
      try {
        const mod = window['CompliancePage'];
        if (mod && mod.render) {
          await mod.render(el, {
          ...
          el.innerHTML = '<div class="coming-soon"><h2>Coming Soon</h2><p>compliance-utilization</p></div>';
        }
      } catch (err) {
